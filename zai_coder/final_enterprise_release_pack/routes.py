...
from zai_coder.final_enterprise_release_pack.status import build_status_report

def route_final_release_status():
    report = build_status_report()
    # We must return a deterministic markdown or JSON-safe string
